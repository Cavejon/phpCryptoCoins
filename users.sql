...
CREATE TABLE `usuarios` (
  ...
  `token` varchar(300) NOT NULL,
  `file_name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `submitted_on` datetime NOT NULL current_timestamp(),
  PRIMARY KEY (`id`)
...
ALTER TABLE
  usuarios
ADD
  COLUMN foto VARCHAR(255);

INSERT INTO
  `usuarios` (`id`, `nome`, `usuario`, `senha`, `token`)
VALUES
  (
    1,
    ...
    'e0dd669bdfe0821b8083fe92b0689426'
  ),
  (
    5,
    'Pedro Lucas Cavejon',
    'cavejon',
    '202cb962ac59075b964b07152d234b70',
    '74279ec3066c02d25fd213654c059a23'
  );
